...
Alice Novel is based on .NET MAUI (.NET 10), so the supported targets of Alice Novel are same as [them of .NET MAUI (.NET 10)](https://learn.microsoft.com/en-us/dotnet/maui/supported-platforms?view=net-maui-10.0).
